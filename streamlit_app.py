...

{
  ...
  "statut_estime": "Aucune | Allégée | Modérée | Élevée | Critique"
    ...
    st.markdown(
        ...
        div[data-testid="stVerticalBlock"]:has(.review-toolbar-clear-scope) .stButton button:disabled,
        div[data-testid="stVerticalBlock"]:has(.review-toolbar-clear-scope) .stButton button:disabled p {{
        ...
        div[data-testid="stVerticalBlock"]:has(.review-toolbar-apply-scope) .stButton button:disabled,
        div[data-testid="stVerticalBlock"]:has(.review-toolbar-apply-scope) .stButton button:disabled p {{
